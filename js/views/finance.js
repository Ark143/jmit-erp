...
function renderFixedAssets(container) {
    ...
    <div class="grid-main-side animate-fade-in">
      ...
      <div class="card">
        <div class="card-header">
          ...
          <button id="run-depr-btn" class="btn btn-danger btn-sm">
  ...
  container.querySelector("#run-depr-btn").addEventListener("click", () => {
  ...
  // Create Fixed Asset
  container.querySelector("#new-asset-form").addEventListener("submit", (e) => {
    e.preventDefault();
    const asset = {
