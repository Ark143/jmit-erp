  ...
  container.innerHTML = `
    <div class="card animate-fade-in">
      <div class="card-header">
        ...
        <button id="add-item-btn" class="btn btn-primary btn-sm" style="background-color: var(--color-inventory);">
          + Register New Item
        </button>
      </div>
...
function renderWarehousesList(container) {
  ...
  container.querySelector("#new-wh-form").addEventListener("submit", (e) => {
    e.preventDefault();
    const wh = {
  ...
  container.innerHTML = `
    <div class="card animate-fade-in">
      <div class="card-header">
        ...
        <button onclick="window.location.hash='#inventory/stock-entries/new'" class="btn btn-primary btn-sm" style="background-color: var(--color-inventory);">
          + New Stock Entry
        </button>
      </div>
      <div class="table-container">
