...
function renderCOATree(container) {
  ...
  container.innerHTML = `
    <div class="card animate-fade-in">
      <div class="card-header">
        ...
        <button id="add-gl-btn" class="btn btn-primary btn-sm">
          + Add GL Account
        </button>
      </div>
  ...
  container.querySelector("#add-gl-btn").addEventListener("click", () => {
  ...
  container.innerHTML = `
    <div class="card animate-fade-in">
      <div class="card-header">
        ...
        <button onclick="window.location.hash='#accounting/journal/new'" class="btn btn-primary btn-sm" style="background-color: var(--color-primary);">
...
function renderJournalEntryForm(container) {
  ...
  const addLine = () => {
    ...
    debitInp.addEventListener("input", () => {
      if (parseFloat(debitInp.value) > 0) creditInp.value = "";
      updateBalances();
    });
    creditInp.addEventListener("input", () => {
      if (parseFloat(creditInp.value) > 0) debitInp.value = "";
      updateBalances();
    });
